...
corresponding
[`ppc_`](https://mc-stan.org/bayesplot/reference/PPC-test-statistics.md)
...
Other PPDs:
[`PPD-distributions`](https://mc-stan.org/bayesplot/reference/PPD-distributions.md),
[`PPD-intervals`](https://mc-stan.org/bayesplot/reference/PPD-intervals.md),
