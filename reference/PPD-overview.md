...
the corresponding
[PPC](https://mc-stan.org/bayesplot/reference/PPC-overview.md) plots but
without showing any observed data. Because these are not "checks"
...
- [PPD-test-statistics](https://mc-stan.org/bayesplot/reference/PPD-test-statistics.md):
