...
using the bayesplot package*]("MCMC-diagnostics.html"), and graphical posterior
...
```{r, mcmc_hist, message=FALSE, fig.height=3}
...
```{r, mcmc_hist_by_chain, message=FALSE, fig.height=3}
...
easily change to a different color scheme, for example:
...
Modeling via Stan. R package version 2.12.1. 
