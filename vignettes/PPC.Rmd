...
Data_](https://cran.r-project.org/web/packages/rstanarm/vignettes/count.html) (Gabry and Goodrich, 2016).
...
```{r ppc_dens_overlay, fig.height=3}
library("ggplot2")
library("bayesplot")
...
```{r ppc_hist-nb-2, fig.width=6, message=FALSE}
...
```{r ppc_stat, fig.height=3, message=FALSE}
...
```{r ppc_stat-nb, fig.height=3, message=FALSE}
...
```{r ppc_stat-max, fig.height=3, message=FALSE}
