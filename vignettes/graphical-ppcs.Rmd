...
This vignette focuses on graphical posterior predictive checks (PPC). Plots of
parameter estimates from MCMC draws and visual MCMC diagnostics are covered in 
separate vignettes.
