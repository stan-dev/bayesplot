---
title: "ppcheck: Graphical Posterior Predictive Checks"
author: "Jonah Gabry"
date: "`r Sys.Date()`"
output: 
...
The **ppcheck** package provides various plotting functions for 
*graphical posterior predictive checking*, that is, creating graphical displays
...
distribution, the functions in the **ppcheck** package create various
...
The **ppcheck** package provides the S3 generic function `pp_check`. Authors of
