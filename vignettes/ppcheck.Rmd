---
title: "ppcheck: Graphical Posterior Predictive Checks for Bayesian Models"
author: "Jonah Gabry"
date: "`r Sys.Date()`"
output: 
...
The __ppcheck__ package provides various plotting functions for 
...
distribution, the functions in the __ppcheck__ package create various
graphical displays comparing the observed data $y$ to the replications.


## Providing an interface to ppcheck from another package

The __ppcheck__ package provides the S3 generic function `pp_check`. Authors of
...
To provide an provide interface to __ppcheck__ from your package, you can very 
...
functions included in __ppcheck__.
...
one of the plotting functions from __ppcheck__.
