...
region. The required step size is connected to the value of `tau`. When is `tau`
...
us diagnose divergences. We may however notice the cluster of divergences after
600th iteration and zoom in to investigate, using the `window` parameter:
