...
n_divergent_in_window <- np_cp %>% filter(Parameter == "divergent__" & Value == 1 & Iteration >= 400 & Iteration <= 550) %>% nrow()
...
user-specified number of lags. Autocorrelation is bad (it means draws are 
