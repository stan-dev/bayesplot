...
and some of the functions demonstrated in the
[_Plotting MCMC draws_](http://mc-stan.org/bayesplot/articles/plotting-mcmc-draws.html)
...
look at a bivariate plot of `tau` and one of the `theta` parameters.
...
divergences (as well as other HMC/NUTS diagnostics). Examples are provided at
`help("mcmc_pairs")`.
