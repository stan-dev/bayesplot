...
[^1]: $n_{eff} > N$` means that the mean value of the parameter computed from Stan draws 
approaches the true mean faster then independent samples from the true posterior 
...
visit [the relevant forum thread](http://discourse.mc-stan.org/t/n-eff-bda3-vs-stan/2608/19)
