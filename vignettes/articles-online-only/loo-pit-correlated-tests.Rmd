...
```{r calibrated, opts.label="fig_wide"}
...
```{r too-wide, opts.label="fig_wide"}
...
```{r too-narrow, opts.label="fig_wide"}
...
| `help_text_shrinkage` | all three | numeric in $(0, 1]$ | `0.8` |
