...
This outlines how to propose a change to bayesplot and is based on
similar instructions for tidyverse packages, including the contributing
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("stan-dev/bayesplot", fork = TRUE)`.
...
Please note that the bayesplot project follows the Stan project’s [Code
of
