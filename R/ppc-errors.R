...
#'   [ggplot2::geom_point()] to control the appearance of the
...
#'    to `arm::binnedplot`) is generated for each dataset (row) in
#'    `yrep`. For this plot `y` and `yrep` should contain
#'    proportions rather than counts, and `yrep` should have only a small
#'    number of rows.
#'   }
#' }
#'
