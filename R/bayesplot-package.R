...
#'   \item \strong{MCMC (algorithm-specific)}:
#'   (Coming soon) Visualizations designed for use with particular MCMC
#'   algorithms. In future releases these will include HMC, HMC + NUTS, Gibbs,
#'   random walk Metropolis, and other variants of MCMC.
