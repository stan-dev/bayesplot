...
test_that("theme_default creates ggplot theme", {
  ...
  expect_s3_class(thm2$axis.ticks, "element_blank")
  expect_null(thm2$axis.ticks.x)
  expect_null(thm2$axis.ticks.y)
  ...
  expect_identical(thm3$axis.ticks.x, ggplot2::element_line())
  expect_identical(thm3$axis.ticks.y, ggplot2::element_line())
})
