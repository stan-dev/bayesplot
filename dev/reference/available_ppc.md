...
[PPC](https://mc-stan.org/bayesplot/dev/reference/PPC-overview.md), or
[PPD](https://mc-stan.org/bayesplot/dev/reference/PPD-overview.md)
module, depending on which function is called. If `pattern` is specified
then a subset of function names is returned.
