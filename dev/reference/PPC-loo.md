...
#> Rounding PIT > 1 to 1.s1' NOW (CHAIN :            adapt_window = 38
#> Chain 1: 2           term_buffer = 5).
#> 
#> Chain 1: 
#> Chain 2: 
#> Chain 2: Gradient evaluation took 0.000337 seconds
#> Chain 2: 1000 transitions using 10 leapfrog steps per transition would take 3.37 seconds.
...
#> Chain 2:                5.196 seconds (Total)
#> Chain 2: 
#> Chain 1: Iteration: 100 / 100 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.805 seconds (Warm-up)
#> Chain 1:                2.472 seconds (Sampling)
#> Chain 1:                5.277 seconds (Total)
#> Chain 1: 
#> Warning: 
