...
#> Rounding PIT > 1 to 1. Gradient evaluation took 0.000413 seconds
#> Chain 2: 1000 transitions using 10 leapfrog steps per transition would take 4.13 seconds.
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.697 seconds (Warm-up)
#> Chain 2:                2.467 seconds (Sampling)
#> Chain 2:                5.164 seconds (Total)
#> Chain 2: 
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.777 seconds (Warm-up)
#> Chain 1:                2.448 seconds (Sampling)
#> Chain 1:                5.225 seconds (Total)
#> Chain 1: 
#> Warning: 
