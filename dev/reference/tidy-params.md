...
#>  $ (Intercept)                        : num  -1.542 -1.95 -0.197 -1.185 -1.951 ...
#>  $ size                               : num  -3.15e-05 9.37e-03 -4.51e-02 -7.04e-03 9.36e-03 ...
#>  $ period2                            : num  -0.853 -1.185 -0.878 -1.083 -0.834 ...
#>  $ period3                            : num  -1.858 -0.643 -1.806 -0.833 -1.178 ...
#>  $ period4                            : num  -1.731 -1.179 -1.878 -1.667 -0.844 ...
#>  $ b[(Intercept) herd:1]              : num  1.581 0.259 0.961 0.227 1.493 ...
#>  $ b[(Intercept) herd:2]              : num  -0.332 -0.389 -0.243 -0.965 0.191 ...
#>  $ b[(Intercept) herd:3]              : num  0.5 0.913 0.185 0.734 0.553 ...
#>  $ b[(Intercept) herd:4]              : num  0.6931 0.1089 -0.2697 0.0288 -0.2462 ...
#>  $ b[(Intercept) herd:5]              : num  -0.685 0.91 -1.137 0.332 -0.255 ...
#>  $ b[(Intercept) herd:6]              : num  -0.264 -0.496 -0.55 -0.978 0.286 ...
#>  $ b[(Intercept) herd:7]              : num  1.286 1.062 0.865 1.218 1.461 ...
#>  $ b[(Intercept) herd:8]              : num  0.758 0.97 0.89 0.363 0.941 ...
#>  $ b[(Intercept) herd:9]              : num  -0.6588 0.3838 -1.0778 0.2056 -0.0889 ...
#>  $ b[(Intercept) herd:10]             : num  -0.0665 -0.5684 -0.5609 -1.1364 -0.3679 ...
#>  $ b[(Intercept) herd:11]             : num  0.212899 0.061923 0.000281 -0.433457 0.463037 ...
#>  $ b[(Intercept) herd:12]             : num  0.0207 0.384 -0.8738 0.6553 -0.5206 ...
#>  $ b[(Intercept) herd:13]             : num  -0.645 -0.684 -0.859 -1.238 -0.671 ...
#>  $ b[(Intercept) herd:14]             : num  0.767 1.512 0.76 1.623 1.142 ...
#>  $ b[(Intercept) herd:15]             : num  -0.58 -0.422 -1.27 -0.39 -0.698 ...
#>  $ Sigma[herd:(Intercept),(Intercept)]: num  0.652 0.923 0.592 0.876 0.714 ...
#> 
...
#>          <dbl>                   <dbl>  <dbl>                      <dbl>
#>  1      0.554                   0.306  0.402                       0.117
#>  2      0.220                   1.61   0.275                       0.991
#>  3      0.371                   0.0561 0.535                       1.04 
#>  4      0.680                   0.0179 1.45                       -0.103
#>  5      0.970                   3.09   0.879                       0.623
#>  6     -1.24                    0.523  0.0443                      1.57 
#>  7     -0.287                   0.837  0.325                       1.20 
#>  8      0.671                   0.0947 0.734                      -0.816
#>  9     -2.46                    0.691  0.629                       0.431
#> 10     -0.0841                  2.89   0.420                       0.645
#> # ℹ 990 more rows
