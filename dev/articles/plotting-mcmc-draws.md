...
- [`help("MCMC-intervals")`](https://mc-stan.org/bayesplot/dev/reference/MCMC-intervals.md)
...
- [`help("MCMC-distributions")`](https://mc-stan.org/bayesplot/dev/reference/MCMC-distributions.md)
...
- [`help("MCMC-scatterplots")`](https://mc-stan.org/bayesplot/dev/reference/MCMC-scatterplots.md)
...
- [`help("MCMC-traces")`](https://mc-stan.org/bayesplot/dev/reference/MCMC-traces.md)
