...
- New module PPD (posterior/prior predictive distribution) with a lot of
  ...
  [`help("PPD-overview")`](https://mc-stan.org/bayesplot/reference/PPD-overview.md)
  for details.
...
- The `pars` argument of all MCMC plotting functions now supports tidy
  ...
  [`help("tidy-params", package="bayesplot")`](https://mc-stan.org/bayesplot/reference/tidy-params.md)
...
- [`bayesplot::theme_default()`](https://mc-stan.org/bayesplot/reference/theme_default.md)
